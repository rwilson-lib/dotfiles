...
#+begin_src emacs-lisp
  (use-package evil
    ...
    :bind (("<escape>" . custom/force-normal-state-or-exit))
  ...
  ;;   (add-hook hook (lambda () (flyspell-mode -1))))
   ...
   (defun langtool-autoshow-detail-popup (overlays)
    ...
    (use-package langtool
     ...
     (setq langtool-language-tool-jar "~/.emacs.d/.cache/lsp/ltex-ls/latest/bin/ltex-cli")
     :config
...
#+begin_src emacs-lisp
  (use-package dictionary
    :bind ((:map evil-normal-state-map
                ("Z?" . dictionary-lookup-definition)
                ("z?" . dictionary-search))))
  #+end_src
** Synosaurus
  #+begin_src emacs-lisp
