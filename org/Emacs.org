...
#+begin_src emacs-lisp
  (use-package general
    ...
    (general-define-key
     ...
     "jr" 'consult-recent-file
     "jS" 'consult-lsp-symbols
     "js" 'consult-lsp-file-symbols
     "oo" 'consult-lsp-file-symbols
     "sr" 'consult-ripgrep
     ":"  'consult-goto-line
     "."  'consult-focus-lines
     "/"  'consult-line
...
#+begin_src emacs-lisp
  ...
  (use-package flycheck-languagetool
    ...
    :init
    (setq flycheck-languagetool-server-jar "~/bin/LanguageTool-5.6/languagetool-server.jar"))
#+end_src
** Dictionary
#+begin_src emacs-lisp
