...
#+begin_src emacs-lisp
  (defun efs/set-font-faces ()
    ...
    (set-face-attribute 'default nil :font "FiraCode Nerd Font" :height 162)

    ;; Set the fixed pitch face
    (set-face-attribute 'fixed-pitch nil :font "FiraCode Nerd Font" :height 162)

    ;; Set the variable pitch face
    (set-face-attribute 'variable-pitch nil :font "FiraCode Nerd Font" :height 162 :weight 'regular))
...
#+begin_src emacs-lisp
  ...
  ;;/Users/rwilson/anaconda3/condabin:/Users/rwilson/bin:/usr/local/bin:/Users/rwilson/Library/Python/3.8/bin:/Users/rwilson/Library/Python/3.9/bin:/Library/PostgreSQL/13/bin:/usr/local/opt/mysql-client/bin:/Users/rwilson/go/bin:./node_modules/.bin:/opt/local/bin:/opt/local/sbin:/Library/Frameworks/Python.framework/Versions/3.9/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/TeX/texbin:/usr/local/go/bin:/usr/local/MacGPG2/bin:/Library/Apple/usr/bin:/Users/rwilson/.cargo/bin
...
#+begin_src emacs-lisp
  ...
  (use-package evil
    ...
    (define-key evil-normal-state-map (kbd "; SPC") 'embark-act)
    ...
    (define-key evil-normal-state-map (kbd "g h") 'evil-multiedit-match-symbol-and-next)
    (define-key evil-normal-state-map (kbd "g H") 'evil-multiedit-match-symbol-and-prev)
    (define-key evil-normal-state-map (kbd "g SPC") 'evil-multiedit-match-all)

    (define-key evil-normal-state-map (kbd "; q") 'evil-tree-state)
