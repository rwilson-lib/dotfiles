...
#+begin_src emacs-lisp
  ...
  (use-package lsp-mode
    ...
    :bind (:map lsp-mode-map
                ...
                ("<tab> TAB" . company-indent-or-complete-common))
...
#+begin_src emacs-lisp
  (use-package google-this
    :config
    (setq google-this-browse-url-function #'xwidget-webkit-browse-url)
    (google-this-mode 1))
#+end_src
** Ledger
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (use-package link-hint
    :bind ((:map evil-normal-state-map
                 ("gslo" . link-hint-open-link)
                 ("gslO" . link-hint-open-multiple-links)
                 ("gslC" . link-hint-copy-all-links)
                 ("gslc" . link-hint-copy-link))))
#+end_src
** Tab-Bar Mode
#+begin_src emacs-lisp
  ;; (setq tab-bar-show 1)
